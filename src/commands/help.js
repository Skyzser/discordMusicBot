...
export default function Help({ message }) {
  const embed = new MessageEmbed()
    ...
    .addFields(
      {
        name: "**__List of all the commands the bot can use:__**",
        value: "\u200B",
      },
      ...
      {
        name: "• Skips the current song or *x* amount of songs:",
        value: "`!skip | !skip <x>`",
      },
      {
      ...
      {
        name: "• Have bot pick an item from a list of items:",
        value: "`!decider <item1 item2 item3>`",
      }
    );
